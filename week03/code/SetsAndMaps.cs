...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        var characCount = new Dictionary<char, int>();
        foreach (var character in word1)
        {
            if (characCount.ContainsKey(character))
            {
                characCount[character]++;
            }
            else
            {
                characCount[character]= 1;
            }
        }
        ...
        foreach (var character in word2)
        {
            ...
            if (characCount[character] < 0)
            {
                return false;
            }

            foreach (var count in characCount.Values)
            {
                if (count != 0)
                {
                    return false;
